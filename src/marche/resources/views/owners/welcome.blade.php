    ...
    <div
        ...
        @if (Route::has('owners.login'))
            <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                @auth('owners')
                    <a href="{{ url('/owners/dashboard') }}"
                        class="text-sm text-gray-700 dark:text-gray-500 underline">Dashboard</a>
                @else
                    <a href="{{ route('owners.login') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">Log
                        in</a>

                    @if (Route::has('owners.register'))
                        <a href="{{ route('owners.register') }}"
